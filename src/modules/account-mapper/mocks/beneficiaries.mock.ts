...
export const beneficiaries: Beneficiary[] = [
  {
    ...
    financialInstitution: 'GREENBANK',
  ...
  },
  {
    ...
    financialInstitution: 'DIGIWALLET',
  ...
  {
    governmentEntity: 'Ministry of Health',
    financialInstitution: 'VOUCHERFSP',
    functionalId: 'BEN-HLT-007',
    financialAddress: 'meena.patel@voucherfsp',
    paymentModality: '(02) Voucher',
  },
  {
    governmentEntity: 'Ministry of Education',
    financialInstitution: 'DIGIWALLET',

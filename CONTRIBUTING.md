...
- Fork the [project](https://github.com/openMF/paymenthub-ee-operationsui-react) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-operationsui-react.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-operationsui-react.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-operationsui-react.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-operationsui-react.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-operationsui-react.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-operationsui-react.git (push)
```
